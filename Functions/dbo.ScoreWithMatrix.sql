...
-- =============================================
CREATE FUNCTION [dbo].[ScoreWithMatrix]
(
	@class CHAR(1),
	@SweetSpot FLOAT,
...
BEGIN
	...
	SET @score = 
				...
				+ dbo.ScoreComponentClassConfig(@class, 43, @CruiseOverspeed, @rprtcfgid)
				+ dbo.ScoreComponentClassConfig(@class, 45, @Matrix, @rprtcfgid)
