CREATE TABLE [dbo].[PassComfTemp]
(
[PassComfId] [bigint] NOT NULL IDENTITY(1, 1),
...
[LastOperation] [smalldatetime] NOT NULL CONSTRAINT [DF_PassComfTemp_LastOperation] DEFAULT (getdate()),
[Archived] [bit] NULL
) ON [PRIMARY]
GO
