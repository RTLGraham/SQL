...
GO
ALTER TABLE [dbo].[EventCopyABC] ADD CONSTRAINT [PK_EventCopyABC] PRIMARY KEY CLUSTERED  ([EventId]) WITH (FILLFACTOR=80, IGNORE_DUP_KEY=ON, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
