...
GO
ALTER TABLE [dbo].[AccumCopy] ADD CONSTRAINT [PK_AccumCopy] PRIMARY KEY CLUSTERED  ([AccumId]) WITH (FILLFACTOR=80, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
