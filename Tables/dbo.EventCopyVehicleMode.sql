CREATE TABLE [dbo].[EventCopyVehicleMode]
(
...
GO
ALTER TABLE [dbo].[EventCopyVehicleMode] ADD CONSTRAINT [PK_EventCopyVehicleMode] PRIMARY KEY CLUSTERED  ([EventId]) WITH (FILLFACTOR=80, IGNORE_DUP_KEY=ON, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
