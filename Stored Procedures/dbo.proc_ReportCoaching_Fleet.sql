...
CREATE PROCEDURE [dbo].[proc_ReportCoaching_Fleet]
(
	@sdate datetime,
	@edate datetime,
...
SELECT
		...
		NULL AS SpeedGaugeColour,NULL AS SpeedGaugeMix,
		...
		NULL AS OverspeedCountColour, NULL AS OverspeedCountMix,
		NULL AS OverspeedHighCountColour, NULL AS OverspeedHighCountMix,
		NULL AS StabilityControlColour, NULL AS StabilityControlMix,
		NULL AS CollisionWarningLowColour, NULL AS CollisionWarningLowMix,
		NULL AS CollisionWarningMedColour, NULL AS CollisionWarningMedMix,
		NULL AS CollisionWarningHighColour, NULL AS CollisionWarningHighMix,
		NULL AS LaneDepartureDisableColour, NULL AS LaneDepartureDisableMix,
		NULL AS LaneDepartureLeftRightColour, NULL AS LaneDepartureLeftRightMix,
		NULL AS SweetSpotTimeColour, NULL AS SweetSpotTimeMix,
		NULL AS OverRevTimeColour, NULL AS OverRevTimeMix,
		NULL AS TopGearTimeColour, NULL AS TopGearTimeMix,
		NULL AS FatigueColour, NULL AS FatigueMix,
		NULL AS DistractionColour, NULL AS DistractionMix
