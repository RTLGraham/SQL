...
CREATE PROCEDURE [dbo].[cu_MessageVehicle_DeleteMessage]
(
	@MessageID INT
)
AS
BEGIN
	...
	BEGIN
		...
		SET @messageCommand = '#ACTION,DELETE,DMSG,' + CAST(@messageId AS VARCHAR(50))
		...
		BEGIN TRANSACTION
			...
			EXEC dbo.cu_MessageVehicle_UpdateMessageStatusWithCode @MessageID, 'Deleting'
		COMMIT TRANSACTION
	END
END
