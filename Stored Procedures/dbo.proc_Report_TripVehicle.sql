...
CREATE PROC [dbo].[proc_Report_TripVehicle]
...
--SET		@vid = N'16DF929B-A773-46D2-900E-2CA8DCF23893' 
--SET		@sdate = '2013-12-20 00:00'
--SET		@edate = '2013-12-27 23:59'
--SET		@uid = N'0D836390-D29E-4FF4-B2B9-359C7ABBE6A9'
...
SELECT
	...
	/*Average RPM*/
	CAST(AVG(AverageEngineRPM) AS INT) as AverageRPM,
	CAST(AVG(AverageEngineRPMWhileDriving) AS INT) as AverageDrivingRPM,
