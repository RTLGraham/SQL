...
CREATE PROCEDURE [dbo].[proc_Report_DrillDown_Driver]
(
	@dids varchar(max), 
	@gids varchar(max), 
	@sdate datetime,
...
--		@calendar TINYINT
--		
--SET @dids = N'82C340C4-F732-43EC-AB31-5C8E0627261D,653D6FF3-89F4-4F3F-A077-0C6E47900018,EF21FEEA-1E12-4EF8-A907-12F153443877,36471D36-2DF5-4976-81EB-20D188F100C5' 
--SET @gids = NULL 
--SET @vehicletypeid = NULL
--SET @routeid = NULL
--SET	@sdate = '2012-01-01 10:00'
--SET	@edate = '2012-03-22 17:00'
...
--			LEFT JOIN dbo.ReportingOverspeed ro ON r.VehicleIntId = ro.VehicleIntId AND r.DriverIntId = ro.DriverIntId AND r.Date = ro.Date AND r.RouteId = ro.RouteId
		...
		GROUP BY p.PeriodNum, d.DriverId /*, gd.GroupId */ WITH CUBE
