...
GO
--
CREATE PROCEDURE [dbo].[proc_ReportPerformance_Individual_Vehicle_Flex_RS]
(
...
SELECT 
		  r1.DriverId AS DetailId,	  
		  DetailName = 
		  CASE
			WHEN (r1.DriverId IS NULL AND r1.WeekNumber IS NULL) THEN r1.Registration
			WHEN (r1.DriverId IS NULL AND r1.WeekNumber IS NOT NULL) THEN
