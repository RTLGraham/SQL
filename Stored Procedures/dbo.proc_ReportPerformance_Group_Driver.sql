...
CREATE PROCEDURE [dbo].[proc_ReportPerformance_Group_Driver]
(
	@gids varchar(max), 
	@sdate datetime,
	@edate datetime,
...
--		@rprtcfgid uniqueidentifier
--
--SET @gids = N'B1235556-3003-469A-884A-FB12117EFEA4,1DC00F70-C47D-4062-8FC6-C88E0F8BB69F'
--SET @gids = N'B1235556-3003-469A-884A-FB12117EFEA4'
--
...
FROM dbo.CustomerDriver cd
	...
	INNER JOIN dbo.GroupDetail gd ON gd.EntityDataId = cd.DriverId
...
--	INNER JOIN dbo.CustomerVehicle dv ON v.VehicleId = dv.VehicleId
--	INNER JOIN dbo.Customer c ON dv.CustomerId = c.CustomerId
--WHERE gd.GroupId IN (SELECT Value FROM dbo.Split(@gids, ','))
