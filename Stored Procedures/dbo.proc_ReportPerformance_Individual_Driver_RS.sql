...
GO
--
CREATE PROCEDURE [dbo].[proc_ReportPerformance_Individual_Driver_RS]
    (
...
AS --DECLARE	@did uniqueidentifier,
--		@sdate datetime,
--		@edate datetime,
--		@uid uniqueidentifier,
--		@rprtcfgid uniqueidentifier
...
--SET @rprtcfgid = N'3FED49AA-15C3-4875-A980-D252A6DAEF80'
    ...
    SELECT  r1.VehicleId AS DetailId,
            DetailName = CASE WHEN ( r1.VehicleId IS NULL
                                     AND r1.WeekNumber IS NULL
                                   ) THEN r1.DriverName
                              WHEN ( r1.VehicleId IS NULL
    ...
    FROM    @ResultSet r1
            LEFT JOIN @ResultSet r2 ON ( r1.VehicleId = r2.VehicleId
                                         OR ( r1.VehicleId IS NULL
                                              AND r2.VehicleId IS NULL
                                            )
                                       )
