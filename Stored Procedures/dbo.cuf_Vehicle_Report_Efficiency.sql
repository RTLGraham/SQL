...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[cuf_Vehicle_Report_Efficiency]
(
...
BEGIN
	...
	EXEC dbo.[proc_GetReportEfficiencyByVehicle_Reporting]
		@vid = @vehicleId,
		@cid = null,
		@sdate = @sdate,
		@edate = @edate,
	...
	SELECT * FROM [dbo].[Vehicle] WHERE VehicleId = @vehicleId
END
