...
CREATE PROCEDURE [dbo].[proc_ReportByConfigIdGroups_Driver]
(
	@gids VARCHAR(MAX),
	@dids varchar(max),
	@sdate datetime,
...
--SET @gids = N'7C1AF9C4-8319-44E4-82D1-5CE1C3756C4F,67595B08-8B2F-4248-AC97-767593433F00'
...
SELECT
		--Group and Driver Identification Data
...
FROM
	...
	FROM
		...
		GROUP BY dg.GroupId, d.DriverId WITH CUBE
