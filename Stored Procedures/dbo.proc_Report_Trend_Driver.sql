...
CREATE PROCEDURE [dbo].[proc_Report_Trend_Driver]
(
	@dids varchar(max), 
	@gids varchar(max), 
	@sdate datetime,
...
SELECT
		...
		Rop, Rop2, OverSpeed, OverSpeedHigh, OverSpeedDistance, IVHOverSpeed,SpeedGauge, CoastOutOfGear, HarshBraking, FuelEcon,NULL,
		Pto, Co2, 
