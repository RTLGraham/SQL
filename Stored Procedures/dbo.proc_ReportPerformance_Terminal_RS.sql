...
-- =============================================
CREATE PROCEDURE [dbo].[proc_ReportPerformance_Terminal_RS]
	@gids varchar(max), 
...
BEGIN
	...
	----SET @gids = N'358AB936-67E5-4F3E-90B6-4F6EA4D7D34A,CA90D055-9EC6-427B-98EA-7600A5FD70BB'
	----SET @isDriver = 1
	
	--SET @gids = N'CE04C50D-EB69-43EA-8E69-0E371242DDF3,629B7E57-93FD-48A7-9450-68DC41CF34E0,897D67BB-8C17-45C1-BDFB-933F10C58913,C030D59D-5DB3-40F8-8666-DB6FC2E611A5,B1D1EC14-48C8-4DC0-9E71-F03758D6D367'
	--SET @isDriver = 0
	...
	WHERE (r2.VehicleId IS NULL AND r2.DriverId IS NULL AND r2.GroupId IS NOT NULL)
